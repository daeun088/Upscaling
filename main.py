...
def run_resize():
    ...
    subprocess.run(["python", "resize.py", input_folder, intermediate_folder])
...
def run_remove_noise():
    ...
    subprocess.run(["python", "remove_noise.py", intermediate_folder, output_folder])
...
def run_padding():
    ...
    subprocess.run(["python", "padding.py", output_folder, output_folder])  # output 폴더로 저장
...
def main():
    ...
    try:
        ...
        run_esrgan(intermediate_folder, intermediate_folder, model_path) 
